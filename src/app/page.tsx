...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-950 to-zinc-900 px-4 py-10 text-zinc-50 overflow-hidden">
      <div className="mx-auto flex min-h-screen w-full max-w-4xl flex-col gap-8">
